...
#include "UnityCG171.cginc"
#include "UnityShaderVariables.cginc"
#include "UnityInstancing.cginc"
#include "UnityStandardConfig.cginc"
#include "UnityStandardInput171.cginc"
#include "UnityPBSLighting.cginc"
#include "UnityStandardUtils171.cginc"
...
VertexOutputForwardBase vertForwardBase (VertexInput v)
{
	...
	float4 offset = v.color * _Distance;
    float4 posWorld = mul(unity_ObjectToWorld, v.vertex + offset);
    #if UNITY_REQUIRE_FRAG_WORLDPOS
        #if UNITY_PACK_WORLDPOS_WITH_TANGENT
    ...
    o.ambientOrLightmapUV = VertexGIForward(v, posWorld, normalWorld);
        ...
        half3 viewDirForParallax = mul (rotation, ObjSpaceViewDir(v.vertex + offset));
...
VertexOutputForwardAdd vertForwardAdd (VertexInput v)
{
    ...
    #ifdef _PARALLAXMAP
        TANGENT_SPACE_ROTATION;
        o.viewDirForParallax = mul (rotation, ObjSpaceViewDir(v.vertex+offset));
    #endif
